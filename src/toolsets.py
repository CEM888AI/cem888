...
_CEM888_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (CEM888_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `cem888 tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (CEM888_KANBAN_TASK env "
    ...
    # ==========================================================================
    # Full CEM888 toolsets (CLI + messaging platforms)
    #
    ...
    "cem888-cli": {
        ...
        "tools": _CEM888_CORE_TOOLS,
        "includes": []
    },

    "cem888-cron": {
        # Mirrors cem888-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `cem888 tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as cem888-cli; gated by `cem888 tools`",
        "tools": _CEM888_CORE_TOOLS,
        "includes": []
    },
    ...
    "cem888-email": {
        "description": "Email bot toolset - interact with CEM888 via email (IMAP/SMTP)",
        "tools": _CEM888_CORE_TOOLS,
        "includes": []
    },
    ...
    "cem888-sms": {
        "description": "SMS bot toolset - interact with CEM888 via SMS (Twilio)",
        "tools": _CEM888_CORE_TOOLS,
        "includes": []
    },
    ...
    "cem888-webhook": {
        ...
        "tools": _CEM888_WEBHOOK_SAFE_TOOLS,
        "includes": []
    },
    ...
    "cem888-gateway": {
        ...
        "tools": [],
        "includes": ["cem888-telegram", "cem888-discord", "cem888-whatsapp", "cem888-slack", "cem888-signal", "cem888-bluebubbles", "cem888-homeassistant", "cem888-email", "cem888-sms", "cem888-mattermost", "cem888-matrix", "cem888-dingtalk", "cem888-feishu", "cem888-wecom", "cem888-wecom-callback", "cem888-weixin", "cem888-qqbot", "cem888-webhook", "cem888-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (cem888-<name>).
        # Gives them _CEM888_CORE_TOOLS plus any tools the plugin registered
        # into a toolset matching the platform name.
        if name.startswith("cem888-"):
            platform_name = name[len("cem888-"):]
            try:
                from gateway.platform_registry import platform_registry
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_CEM888_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
