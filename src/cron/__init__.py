"""
Cron job scheduling system for CEM888 Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    cem888 gateway install    # Install as a user service
    sudo cem888 gateway install --system  # Linux servers: boot-time system service
    cem888 gateway            # Or run in foreground
