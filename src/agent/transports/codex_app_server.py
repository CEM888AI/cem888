...
projection into CEM888' display, approval bridging, transcript projection into
...
"codex_app_server"`. CEM888' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("CEM888_KANBAN_TASK"):
            kanban_db = spawn_env.get("CEM888_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "CEM888_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("CEM888_HOME", os.path.expanduser("~/.cem888")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "cem888",
        client_title: str = "CEM888 Agent",
