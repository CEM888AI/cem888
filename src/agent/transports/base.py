...
class ProviderTransport(ABC):
    ...
    def api_mode(self) -> str:
        """The api_mode string this transport handles (e.g. 'cem888ai_messages')."""
        ...
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        Returns provider-specific structure (e.g. (system, messages) for CEM888.AI,
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        Returns provider-specific tool list (e.g. CEM888.AI input_schema format).
        """
        ...
