...
providers (OpenRouter, CEM888.AI, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate CEM888/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from CEM888'
    ...
    # is stricter (low/high). Clamp CEM888' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - CEM888-internal scaffolding markers — any top-level message key
          ...
          CEM888.AI) silently drop unknown message keys, but strict
        ...
        for msg in sanitized:
            ...
            # Drop all CEM888-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # CEM888 on OpenRouter/CEM888.AI max output
            cem888ai_max_output: int | None
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (CEM888.AI, OpenRouter,
        ...
        cem888ai_max_out = params.get("cem888ai_max_output")
        ...
        elif cem888ai_max_out is not None:
            api_kwargs["max_tokens"] = cem888ai_max_out
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        cem888ai_max = params.get("cem888ai_max_output")
        ...
        elif cem888ai_max is not None:
            api_kwargs["max_tokens"] = cem888ai_max
