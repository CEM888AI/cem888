...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - cem888_home (str): The active CEM888_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.cem888``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "cem888").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'cem888 memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], cem888_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'cem888 memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``cem888_home`` is the active CEM888_HOME directory path.
