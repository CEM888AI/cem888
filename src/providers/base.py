...
def _profile_user_agent() -> str:
    """Return a ``cem888-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from cem888_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"cem888-cli/{_ver}"
    except Exception:
        return "cem888-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # cem888-cli UA so the catalog endpoint is reachable.
