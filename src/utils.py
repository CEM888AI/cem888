"""Shared utility functions for cem888-agent."""
...
def atomic_replace(tmp_path: Union[str, Path], target: Union[str, Path]) -> str:
    ...
    ``~/.cem888/`` to a git-tracked profile package or dotfiles repo
    (GitHub #16743).
...
def safe_json_loads(text: str, default: Any = None) -> Any:
    ...
    pattern duplicated across display.py, cem888ai_adapter.py,
...
def base_url_hostname(base_url: str) -> str:
    ...
    (``api.openai.com``, ``api.x.ai``, ``api.cem888ai.com``) instead of
