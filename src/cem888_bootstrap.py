"""Windows UTF-8 bootstrap for CEM888 entry points.
...
should be imported at the very top of every CEM888 entry point
(``cem888``, ``cem888-agent``, ``cem888-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import cem888_bootstrap``
# (or ``from cem888_bootstrap import apply_windows_utf8_bootstrap``) at
