...
def setup_model_provider(config: dict, *, quick: bool = False):
    ...
    if _vision_needs_setup:
        _prov_names = {
            "nous-api": "CEM888.AI Portal API key",
...
def _run_portal_one_shot(config: dict) -> None:
    ...
    if already_logged_in:
        ...
        # identical to `cem888 auth add nous --type oauth`. SimpleNamespace
        ...
        try:
            ...
            print_info("  You can retry later with `cem888 auth add nous --type oauth`.")
            return
        except (KeyboardInterrupt, EOFError):
            print()
