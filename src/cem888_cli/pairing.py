...
Usage:
    cem888 pairing list              # Show all pending + approved users
    cem888 pairing approve <platform> <code>  # Approve a pairing code
    cem888 pairing revoke <platform> <user_id> # Revoke user access
    cem888 pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle cem888 pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: cem888 pairing {list|approve|revoke|clear-pending}")
        print("Run 'cem888 pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.cem888/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'cem888 pairing list' to see pending codes.\n")
