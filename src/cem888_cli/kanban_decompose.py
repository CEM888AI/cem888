...
Invoked by ``cem888 kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the CEM888 Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cem888_cli.kanban._profile_author``."""
    return (
