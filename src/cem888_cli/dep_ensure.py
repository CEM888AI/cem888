...
def _has_cem888_agent_browser() -> bool:
    ...
    # install.sh installs globally into $CEM888_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-CEM888Home", str(get_cem888_home()),
        ]
    else:
