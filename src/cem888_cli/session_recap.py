...
Inspired by CEM888 Code's `/recap` command (v2.1.114, April 2026), which
...
Source: https://code.cem888.com/docs/en/whats-new/2026-w17

Differences from CEM888 Code:
    ...
    - Works unchanged on CLI and every gateway platform (Telegram,
      ...
      helper. CEM888 Code only shows this on the CLI.
    - Tailored to cem888-agent's tool vocabulary (``terminal``, ``patch``,
