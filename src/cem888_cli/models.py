...
def get_curated_nous_model_ids() -> list[str]:
    ...
    """
    try:
        from cem888_cli.model_catalog import get_curated_nous_models
...
_DEFAULT_CEM888_INFERENCE_BASE = "https://inference-api.nousresearch.com"
...
def _resolve_nous_pricing_credentials() -> tuple[str, str]:
    ...
    """
    try:
        from cem888_cli.auth import resolve_nous_runtime_credentials
...
def detect_static_provider_for_model(
    ...
    # If someone types `/model nous` or `/model cem888ai`, treat it as a
...
def provider_model_ids(provider: Optional[str], *, force_refresh: bool = False) -> list[str]:
    ...
    if normalized == "cem888":
        ...
        try:
            from cem888_cli.auth import fetch_nous_models, resolve_nous_runtime_credentials
            creds = resolve_nous_runtime_credentials()
            if creds:
...
def _credential_fingerprint(provider: str) -> str:
    ...
    (codex, copilot, cem888ai-via-cem888-code, nous portal), the
