...
_NOUS_CEM888_NON_AGENTIC_RE = re.compile(
    r"(?:^|[/:])cem888[-_ ]?[34](?:[-_.:]|$)",
    re.IGNORECASE,
)


def is_nous_cem888_non_agentic(model_name: str) -> bool:
    ...
    if not model_name:
        return False
    return bool(_NOUS_CEM888_NON_AGENTIC_RE.search(model_name))
...
def list_authenticated_providers(
    ...
    curated["cem888"] = get_curated_nous_model_ids()
    ...
    # --- 2. Check CEM888-only providers (nous, openai-codex, copilot, opencode-go) ---
