"""
Cron subcommand for cem888 CLI.
...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'cem888 cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: cem888 gateway install", Colors.DIM))
        print(color("                    sudo cem888 gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    cem888 gateway install    # Install as a user service")
        print("    sudo cem888 gateway install --system  # Linux servers: boot-time system service")
        print("    cem888 gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: cem888 cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
