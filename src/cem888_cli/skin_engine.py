"""CEM888 CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.cem888/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "CEM888 Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ CEM888 "       # Response box header label
...
.. code-block:: python
    ...
    from cem888_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "CEM888 Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.cem888/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic CEM888 gold/kawaii (the current look)
...
Drop a YAML file in ``~/.cem888/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CEM888_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CEM888_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic CEM888 — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "CEM888 Agent",
            "welcome": "Welcome to CEM888 Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ CEM888 ",
            "prompt_symbol": "❯",
...
[dim #4A4A4A]⠀⠀⠀⠀⠀⠀⠀⠀⠀the boulder⠀⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "charizard": {
        "name": "charizard",
        "description": "Volcanic theme — burnt orange and sparks",
        "colors": {
        ...
        "spinner": {
            ...
            "thinking_verbs": [
                ...
                "tracking sparks", "setting wing angle", "holding the flame core",
