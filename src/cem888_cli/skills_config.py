"""
Skills configuration for CEM888 Agent.
`cem888 skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.cem888/config.yaml under:
...
from cem888_cli.config import cfg_get, load_config, save_config
from cem888_cli.colors import Colors, color
from cem888_cli.platforms import PLATFORMS as _PLATFORMS
