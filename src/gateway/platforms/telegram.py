...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("CEM888_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
        ...
        self._text_batch_delay_seconds = self._env_float_clamped(
            "CEM888_TELEGRAM_TEXT_BATCH_DELAY_SECONDS",
            0.3,
            min_value=0.08,
            max_value=2.0,
        )
        self._text_batch_split_delay_seconds = self._env_float_clamped(
            "CEM888_TELEGRAM_TEXT_BATCH_SPLIT_DELAY_SECONDS",
            1.0,
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. CEM888-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `cem888 update` or `--replace` handoffs)
        ...
        message = (
            ...
            "To recover: ensure no other CEM888 or OpenClaw instance is running "
            "with this token, then restart the gateway with 'cem888 gateway restart'."
    ...
    def _persist_dm_topic_thread_id(
        ...
        try:
            ...
            config_path = get_cem888_home() / "config.yaml"
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the CEM888 process (shared mount, same machine, etc.).
            ...
            request_kwargs = {
                "connection_pool_size": _env_int("CEM888_TELEGRAM_HTTP_POOL_SIZE", 512),
                "pool_timeout": _env_float("CEM888_TELEGRAM_HTTP_POOL_TIMEOUT", 8.0),
                "connect_timeout": _env_float("CEM888_TELEGRAM_HTTP_CONNECT_TIMEOUT", 10.0),
                "read_timeout": _env_float("CEM888_TELEGRAM_HTTP_READ_TIMEOUT", 20.0),
                "write_timeout": _env_float("CEM888_TELEGRAM_HTTP_WRITE_TIMEOUT", 20.0),
            }

            # Fallback IPs disabled in CEM888 fork
            ...
            try:
                ...
                from cem888_cli.commands import telegram_menu_commands
    ...
    async def send_update_prompt(
        ...
        Used by the gateway ``/update`` watcher when ``cem888 update --gateway``
    ...
    # Scripts live in ~/.cem888/scripts/gmail-triage/. `arg` from the callback
    ...
    async def _handle_gmail_triage_callback(
        ...
        *,
        ...
        script_path = _Path.home() / ".cem888" / "scripts" / "gmail-triage" / script_name
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@cem888_bot.example" are not mentions
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several CEM888 bot profiles. A message like
