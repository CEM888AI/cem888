...
the get_anchored_view / get_messages_around primitives in cem888_state.
...
# Third-party integrations tag their sessions with CEM888_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from cem888_state import get_default_db_path
