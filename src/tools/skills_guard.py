...
Trust levels:
  - builtin:   Ships with CEM888. Never scanned, always trusted.
  - trusted:   openai/skills and cem888ais/skills only. Caution verdicts allowed.
...
TRUSTED_REPOS = {"openai/skills", "cem888ais/skills", "huggingface/skills"}
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.cem888/\.env|\~/\.cem888/\.env',
     "cem888_env_access", "critical", "exfiltration",
     "directly references CEM888 secrets file"),
    ...
    (r'\.cem888/config\.yaml|\.cem888/SOUL\.md',
     "cem888_config_mod", "critical", "persistence",
     "references CEM888 configuration files directly"),
    (r'\.cem888/settings|\.codex/config',
    ...
    (r'sk-ant-[A-Za-z0-9_-]{90,}',
     "cem888ai_key_leaked", "critical", "credential_exposure",
     "possible CEM888.AI API key in skill content"),
    (r'AKIA[0-9A-Z]{16}',
