...
Unlike #4562's CEM888.AI-native `computer_20251124` tool, the schema here is
...
eviction in the CEM888.AI adapter, image-aware token estimation, the
COMPUTER_USE_GUIDANCE prompt block, approval hook, and the skill) live
alongside this package. See agent/cem888ai_adapter.py and
