...
(see AGENTS.md, CEM888.md, etc.) to flag.  See the pattern comments for
...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CODEX|AGENT|OPENAI)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.cem888/\.env|\~/\.cem888/\.env', "cem888_env", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*(?:AGENTS\.md|\.cursorrules|\.clinerules)', "agent_config_mod", "strict"),
    (r'(update|modify|edit|write|change|append|add\s+to)\s+.*\.cem888/(config\.yaml|SOUL\.md)', "cem888_config_mod", "strict"),
