"""Persistent slash-command worker — one CEM888CLI per TUI session.
...
from cli import CEM888CLI
from rich.console import Console


def _run(cli: CEM888CLI, command: str) -> str:
...
def main():
    ...
    os.environ["CEM888_SESSION_KEY"] = args.session_key
    os.environ["CEM888_INTERACTIVE"] = "1"

    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        cli = CEM888CLI(model=args.model or None, compact=True, resume=args.session_key, verbose=False)
